...
if __name__ == "__main__":
    ...
    # if use_wandb:
    #     wandb.init(project='masklm', name=args.exp_name, config=args)
    ...
    roberta.load_state_dict(torch.load(os.path.join(args.output_dir, "bert_model.bin")))
    insert_net.load_state_dict(torch.load(os.path.join(args.output_dir, "insert_model.bin")))
